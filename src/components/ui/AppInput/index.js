...
/**
 * AppInput — web translation of the React Native AppInput component.
 *
 * @example
 * <AppInput id="email" label="E-post" type="email" value={email} onChangeText={setEmail} />
 * <AppInput id="password" label="Lösenord" password value={password} onChangeText={setPassword} />
 */
